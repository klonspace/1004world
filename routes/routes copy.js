...
module.exports = function (upload, chat, stream) {
    ...
    router.post('/addStream', requiresLogin,  requiresHost, upload.none(),  async function (req, res, next) {
        console.log(req.files)
       
        // var log = await StreamHandler.addStream(req.body, req.userInfo._id);
        // //console.log(log)
    ...
    router.post('/editStream', requiresLogin,  requiresHost, upload.none(), async function (req, res, next) {
        console.log(req)
        console.log("whut")
        return res.json({ 'success': 'conflict' });
        // var log = await StreamHandler.editStream(req.body, req.userInfo._id);
        //console.log(log)
        // if (log == "saved") return res.json({ 'success': 'saved' });
        // else if (log == "conflict") return res.json({ 'success': 'conflict' });
